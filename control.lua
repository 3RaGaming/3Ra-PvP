...
function join_a_team(event, joining, opposing)
	local s = game.surfaces.nauvis
	local p = game.players[event.player_index]
	print("[PUPDATE]| "..game.players[player].name.." | force | "..joining) -- Print for human readability
	print("PLAYER$force," .. player .. "," .. game.players[player].name .. "," .. joining) -- Print for computer parsing
